...
GRANT
    ALL PRIVILEGES ON garage.* TO 'garage_admin' @'localhost'
WITH
GRANT OPTION;
...
DROP TABLE IF EXISTS option_car;

CREATE TABLE
    IF NOT EXISTS option_car(
        option_car_id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
        option_id INT(11) NOT NULL,
        car_id INT(11) NOT NULL,
        CONSTRAINT fk_option_car_option_id FOREIGN KEY (option_id) REFERENCES option (option_id),
        CONSTRAINT fk_option_car_car_id FOREIGN KEY (car_id) REFERENCES car (car_id)
    ) ENGINE = InnoDB;